...
using Phoogle.Web.Authentication.JwtBearer;
using Phoogle.Web.Authentication.TwoFactor;
using Phoogle.Web.Configuration;
#if FEATURE_SIGNALR
using Abp.Web.SignalR;
#endif

namespace Phoogle.Web
{
    [DependsOn(
        typeof(PhoogleApplicationModule),
        typeof(PhoogleEntityFrameworkCoreModule),
    ...
    public class PhoogleWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PhoogleWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(PhoogleApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PhoogleWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(PhoogleWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
