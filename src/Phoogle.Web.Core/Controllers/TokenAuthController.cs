...
using Phoogle.Web.Models.TokenAuth;
using Phoogle.Authorization.Impersonation;
using Phoogle.Identity;
using Phoogle.Notifications;
using Phoogle.Web.Authentication.External;

namespace Phoogle.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : PhoogleControllerBase
    {
