...
using Phoogle.Url;
using Phoogle.Web.Public.Startup;
using Phoogle.Web.Session;

namespace Phoogle.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PhoogleViewComponent
    {
