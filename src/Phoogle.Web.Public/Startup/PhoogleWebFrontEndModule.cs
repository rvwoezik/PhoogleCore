...
namespace Phoogle.Web.Public.Startup
{
    [DependsOn(
        typeof(PhoogleWebCoreModule)
    )]
    public class PhoogleWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PhoogleWebFrontEndModule(IHostingEnvironment env, PhoogleEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PhoogleWebFrontEndModule).GetAssembly());
        }
    }
}
