...
namespace Phoogle.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PhoogleServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Phoogle", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
