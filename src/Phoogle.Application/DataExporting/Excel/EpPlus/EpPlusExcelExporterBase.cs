...
using Phoogle.Dto;
using Phoogle.Net.MimeTypes;
using OfficeOpenXml;

namespace Phoogle.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : PhoogleServiceBase, ITransientDependency
    {
