...
using Phoogle.Tenants.Dashboard.Dto;

namespace Phoogle.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : PhoogleAppServiceBase, ITenantDashboardAppService
    {
