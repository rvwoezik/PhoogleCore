...
using Phoogle.Authorization.Users.Profile.Cache;
using Phoogle.Authorization.Users.Profile.Dto;
using Phoogle.Friendships;
using Phoogle.Identity;
using Phoogle.Security;
using Phoogle.Storage;
using Phoogle.Timing;

namespace Phoogle.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PhoogleAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Phoogle",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Phoogle",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
