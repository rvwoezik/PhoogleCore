...
using Phoogle.Authorization.Permissions;
using Phoogle.Authorization.Permissions.Dto;
using Phoogle.Authorization.Roles.Dto;

namespace Phoogle.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : PhoogleAppServiceBase, IRoleAppService
    {
