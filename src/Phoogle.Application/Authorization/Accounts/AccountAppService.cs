...
using Phoogle.Authorization.Accounts.Dto;
...
namespace Phoogle.Authorization.Accounts
{
    public class AccountAppService : PhoogleAppServiceBase, IAccountAppService
    {
