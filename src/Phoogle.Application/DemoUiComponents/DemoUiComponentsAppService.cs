...
using Phoogle.DemoUiComponents.Dto;

namespace Phoogle.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PhoogleAppServiceBase, IDemoUiComponentsAppService
    {
