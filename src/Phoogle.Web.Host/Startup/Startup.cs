...
using Phoogle.Web.IdentityServer;

#if FEATURE_SIGNALR
using Phoogle.Web.Owin;
using Abp.Owin;
...
namespace Phoogle.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "Phoogle API", Version = "v1" });
            ...
            return services.AddAbp<PhoogleWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Phoogle API V1");
            }); //URL: /swagger
        }
        ...
        private static void ConfigureOwinServices(IAppBuilder app)
        {
            ...
            app.Properties["host.AppName"] = "Phoogle";
